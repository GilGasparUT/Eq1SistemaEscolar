 ...
 <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    <ul class="navbar-nav">
      <li class="nav-item d-none d-sm-inline-block">
        <a  href="SGrupoo" class="nav-link">Regresar</a>
      </li>
    </ul>
	...
	<section class="h-100">
		<div class="container h-100">
		   ...
		   <div class="card-body p-5">
			  ...
			  <input type="text" name="tfLetra"        value=""    maxlength="20"class="form-control">
                          <br>
			  ...
			  <input type="text" name="tfTurno"      value=""    maxlength="20" class="form-control">
                          <br>
			  ...
			  <input type="text" name="tfClaveCarrera"   value=""    maxlength="20" class="form-control">
			       ...
			       Agregar
                          ...
                          <a href="SGrupo"><button class="btn btn-primary ms-auto">
			        Regresar
			  </button></a>
		  </form>
                </div>
