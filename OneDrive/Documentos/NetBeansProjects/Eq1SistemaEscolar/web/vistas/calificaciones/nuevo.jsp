	...
	<section class="h-100">
		<div class="container h-100">
		   ...
		   <div class="card-body p-5">
			  ...
			  <input type="text" name="tfClaveCalificacion"   value=""    maxlength="20" class="form-control">
                          <br>
                          <label class="mb-2 text-muted">Parcial 1</label>
			  <input type="text" name="tfP1"   value=""    maxlength="20" class="form-control">
                          <br>
                          <label class="mb-2 text-muted">Parcial 2</label>
			  <input type="text" name="tfP2"        value=""    maxlength="20"class="form-control">
                          <br>
                          <label class="mb-2 text-muted">Parcial 3</label>
			  <input type="text" name="tfP3"   value=""    maxlength="20" class="form-control">
                          <br>
                          <label class="mb-2 text-muted">Extra</label>
			  <input type="text" name="tfExtra"      value=""    maxlength="20" class="form-control">
                          <br>
                          <label class="mb-2 text-muted">Clave_Asignacion</label>
			  <input type="text" name="tfClaveAsignacion"    value=""    maxlength="20" class="form-control">
                          <br>
                          <label class="mb-2 text-muted">Clave_Inscripcion</label>
			  <input type="text" name="tfClaveInscripcion"        value=""    maxlength="20" class="form-control">
                          <br>
