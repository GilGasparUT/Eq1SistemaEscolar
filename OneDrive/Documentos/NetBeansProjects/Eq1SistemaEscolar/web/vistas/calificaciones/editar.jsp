...
<head>
  ...
  <title>EditarCalificacion</title>
...
<body class="hold-transition sidebar-mini">
              <% 
                    ...
                    String clavecalificacion = request.getAttribute("clavecalificacion").toString();
                    calificacion          = dao.buscar(clavecalificacion);
              %>
<div class="wrapper">
 ...
 <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    <ul class="navbar-nav">
      <li class="nav-item d-none d-sm-inline-block">
        <a  href="SCalificacion" class="nav-link">Regresar</a>
      </li>
    </ul>
	...
	<section class="h-100">
		<div class="container h-100">
		   ...
		   <div class="card-body p-5">
			  ...
			  <input type = "hidden" name ="tfClaveCalificacionOld" value="<%=calificacion.getClavecalificacion()%>">
                          
                          <label class="mb-2 text-muted">Clave_Calificacion</label>
			  <input type="text" name="tfClaveCalificacion"   value="<%=calificacion.getClavecalificacion()%>"maxlength="20" class="form-control">
                          <br>
                          <label class="mb-2 text-muted">Parcial 1</label>
			  <input type="text" name="tfP1"           value="<%=calificacion.getP1()%>"maxlength="20" class="form-control">
                          <br>
                          <label class="mb-2 text-muted">Parcial 2</label>
			  <input type="text" name="tfP2"          value="<%=calificacion.getP2()%>"maxlength="20" class="form-control">
                          <br>
			  ...
			  <input type="text" name="tfClaveInscripcion"       value="<%=calificacion.getClaveinscripcion()%>"maxlength="20" class="form-control">
                          <br>
                             <button type="submit" name="tfAccion" value="Actualizar" class="btn btn-primary ms-auto">
			       Actualizar
			  </button>
                          <a href="SCalificacion"><button class="btn btn-primary ms-auto">
			        Regresar
			  </button></a>
		  </form>
                </div>
