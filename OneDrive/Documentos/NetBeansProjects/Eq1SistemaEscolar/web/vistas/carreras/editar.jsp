...
<body class="hold-transition sidebar-mini">
              <% 
                    ...
                    String clavecarrera = request.getAttribute("clavecarrera").toString();
                    carrera           = dao.buscar(clavecarrera);
              %>
<div class="wrapper">
 ...
 <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    <ul class="navbar-nav">
      <li class="nav-item d-none d-sm-inline-block">
        <a  href="SCarrera" class="nav-link">Regresar</a>
      </li>
    </ul>
	...
	<section class="h-100">
		<div class="container h-100">
		   ...
		   <div class="card-body p-5">
			  ...
			  <input type = "hidden" name ="tfClaveCarreraOld" value="<%=carrera.getClavecarrera()%>">
                          
                          <label class="mb-2 text-muted">Clave_Carrera</label>
			  <input type="text" name="tfClaveCarrera"   value="<%=carrera.getClavecarrera()%>"maxlength="20" class="form-control">
                          <br>
                          <label class="mb-2 text-muted">Nombre de la Carrera</label>
			  <input type="text" name="tfCarrera"           value="<%=carrera.getCarrera()%>"maxlength="50" class="form-control">
                          <br>
                          
                             <button type="submit" name="tfAccion" value="Actualizar" class="btn btn-primary ms-auto">
			       Actualizar
			  </button>
                          <a href="SCarrera"><button class="btn btn-primary ms-auto">
			        Regresar
			  </button></a>
		  </form>
                </div>
