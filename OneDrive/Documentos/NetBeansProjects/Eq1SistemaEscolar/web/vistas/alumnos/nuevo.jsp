  ...
  <div class="content-wrapper">
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-6">
          <div class="col-sm-6">
              <h1 class="m-5">Agregar Nuevo Alumno</h1>
          </div>
          <div class="col-sm-6">
           ...
           <form action="SAlumno" method="POST">
            Matricula:               <input type="text" name="tfMatricula"   value=""    maxlength="20"/> <br>
            CURP:                    <input type="text" name="tfCURP"        value=""    maxlength="20"/><br>
            Nombre:                  <input type="text" name="tfNombre"      value=""    maxlength="20"/><br>
            Apellidos:               <input type="text" name="tfApellidos"   value=""    maxlength="20"/><br>
            Fecha Nacimiento:        <input type="text" name="tfFechaNac"    value=""    maxlength="20"/><br>
            Sexo:                    <input type="text" name="tfSexo"        value=""    maxlength="20"/><br><br>
                                     <input type="submit" name="tfAccion"    value="Agregar"/>
