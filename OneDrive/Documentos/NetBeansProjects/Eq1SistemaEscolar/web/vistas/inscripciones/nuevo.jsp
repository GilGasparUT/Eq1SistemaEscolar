	...
	<section class="h-100">
		<div class="container h-100">
		   ...
		   <div class="card-body p-5">
			  ...
			  <input type="text" name="tfIdIns"   value=""    maxlength="20" class="form-control">
                          <br>
                          <label class="mb-2 text-muted">Fecha Inscripcion</label>
			  <input type="text" name="tfFechaInscripcion"   value=""    maxlength="20" class="form-control">
                          <br>
                          <label class="mb-2 text-muted">ClaveGrupo</label>
			  <input type="text" name="tfClaveGrupo"        value=""    maxlength="20"class="form-control">
                          <br>
